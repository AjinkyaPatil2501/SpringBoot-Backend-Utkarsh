...
public class CustomerCrudController {
	...
	public ResponseEntity<?> getCustomer(@PathVariable String customerId) {
		return ResponseEntity.ok(customercrudsevice.getCustomer(customerId));
	}
...
//		return ResponseEntity.ok(customercrudsevice.searchByFirstName(firstName));
//	}
//
//	// SEARCH BY LAST NAME
//	@GetMapping("/lastname/{lastName}")
//	public ResponseEntity<?> searchByLastName(@PathVariable String lastName) {
//		return ResponseEntity.ok(customercrudsevice.searchByLastName(lastName));
//	}
...
//    	CustomerFullViewDto ct= customercrudsevice.getFullCustomer(customerId);
//    	System.out.println(ct.getAssets());
