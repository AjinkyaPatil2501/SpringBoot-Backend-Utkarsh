...
public class CustomerCrudServiceImpl implements CustomerCrudService {
	...
	@Override
	@Transactional
	public @Nullable Object getCustomer(String customerId) {
	...
	@Override
	@Transactional
	public @Nullable Object searchByFirstName(String firstName) {
		List<CustomerMaster> list = customerMasterDao.findByFirstNameContainingIgnoreCase(firstName);
		return list;
	}

	@Override
	@Transactional
	public @Nullable Object searchByLastName(String lastName) {
		List<CustomerMaster> list = customerMasterDao.findByLastNameContainingIgnoreCase(lastName);
		return list;
	}
...
//		return companyCustomerDetailsDao.findAll(PageRequest.of(0, 50)).getContent();
	}   
